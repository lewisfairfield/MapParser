package net.plexverse.mapparser.menu.items.data;
...
import net.plexverse.mapparser.menu.items.data.deserializers.*;
import net.plexverse.mapparser.menu.items.data.serializers.*;
